...
/// </summary>
internal interface IPolicyValueNetBuilder
{
...
internal sealed class MlpNetBuilder(int[] hidden) : IPolicyValueNetBuilder
{
...
internal sealed class ConvNetBuilder(int planes, int boardH, int boardW, int filters, int blocks) : IPolicyValueNetBuilder
{
