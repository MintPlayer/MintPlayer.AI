...
- **B4 — Tier-occupancy grid (~112–140 dims, the structural fix):** a 14-col × ~8–10-row grid encoding
  ...
  > **Implemented + measured 2026-07-06 (commit `d8e6893`, branch since removed) — NULL result, NOT shipped.** Appended a
  ...
  > ceiling. Code preserved at commit `d8e6893` (tag `archive/fruitcake-tier-grid-b4`) as a validated-capability
  > artifact (like NoisyNets/F6); **never merged** (the
