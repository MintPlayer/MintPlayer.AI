...
- Code kept on branch `fruitcake-tier-grid` as a validated-capability artifact (like NoisyNets / F6 distillation);
  **not merged** — the 229-dim observation would desync the live 89-dim browser net (`wwwroot/models/fruitcake-net.ckpt`).
