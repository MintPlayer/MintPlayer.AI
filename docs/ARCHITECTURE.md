...
| [`BlockDudeSearch.cs`](../src/MintPlayer.AI.ReinforcementLearning.Campaigns/BlockDude/BlockDudeSearch.cs) | Net-guided weighted A\* over `Core.Planning`. The value head IS the heuristic. Greedy 0/15 → 5/15 with this. |
