...
public class ValueIterationTests
{
    ...
    public void FrozenLake_OptimalPolicy_Solves70PercentOfEpisodes()
    {
        ...
        var eval = RLNet.Core.Training.Evaluator.Evaluate(env, agent, episodes: 2000, seed: 7);
    ...
    private sealed class OraclePolicy(ValueIterationResult oracle) : RLNet.Core.Agents.IAgent<int, int>
    {
